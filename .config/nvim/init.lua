...
do
  ...
  -- Disable default mappings so we can define them explicitly.
  vim.g.tmux_navigator_no_mappings = 1

  vim.keymap.set('n', '<C-h>', '<Cmd>TmuxNavigateLeft<CR>', { desc = 'Navigate left (tmux/nvim)' })
  vim.keymap.set('n', '<C-j>', '<Cmd>TmuxNavigateDown<CR>', { desc = 'Navigate down (tmux/nvim)' })
  vim.keymap.set('n', '<C-k>', '<Cmd>TmuxNavigateUp<CR>', { desc = 'Navigate up (tmux/nvim)' })
